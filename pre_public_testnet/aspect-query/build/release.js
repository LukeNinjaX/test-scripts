...
import * as __import7 from "blockchain-api";
import * as __import8 from "trace-api";
async function instantiate(module, imports = {}) {
  ...
  const __module7 = imports["blockchain-api"];
  const __module8 = imports["trace-api"];
  const adaptedImports = {
    ...
    "blockchain-api": Object.assign(Object.create(__module7), {
      "__BlockchainApi__.getTransactionByHash"(hash) {
        // ~lib/@artela/aspect-libs/hostapi/blockchain-api/__BlockchainApi__.getTransactionByHash(i32) => i32
        return __module7.__BlockchainApi__.getTransactionByHash(hash);
      },
    }),
    "trace-api": Object.assign(Object.create(__module8), {
      "__TraceApi__.queryCallTree"(query) {
        // ~lib/@artela/aspect-libs/hostapi/trace-api/__TraceApi__.queryCallTree(i32) => i32
        return __module8.__TraceApi__.queryCallTree(query);
      },
    }),
  };
...
export const {
  ...
  await (async () => {
    ...
    "blockchain-api": __maybeDefault(__import7),
    "trace-api": __maybeDefault(__import8),
  }
