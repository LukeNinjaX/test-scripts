...
const web3 = common.connectToANode()
...
const erc20Bytes = fs.readFileSync("./contract/erc20.bin", "utf-8")
const erc20Abidata = fs.readFileSync("./contract/erc20.abi", "utf-8")
var erc20Abi = JSON.parse(erc20Abidata);

const allAspectPath = './aspect/all.wasm';

const ARTELA_ADDR = "0x0000000000000000000000000000000000A27E14";

const bank = common.login(web3)
...
async function estimeateGasTransfer() {
    ...
    // const receiverPK = "0xb4f7eb534165f83025bc30f0add655805d9da066ef2bca04e59fb6f74c38acb8";
    // const receiver = web3.eth.accounts.privateKeyToAccount(receiverPK);
