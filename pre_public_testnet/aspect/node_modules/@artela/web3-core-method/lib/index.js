...
Method.prototype._confirmTransaction = function (defer, result, payload) {
    var method = this, promiseResolved = false, canUnsubscribe = true, timeoutCount = 0, confirmationCount = 0, intervalId = null, blockHeaderTimeoutId = null, lastBlock = null, receiptJSON = '', gasProvided = ((!!payload.params[0] && typeof payload.params[0] === 'object') && payload.params[0].gas) ? payload.params[0].gas : null, isContractDeployment = (!!payload.params[0] && typeof payload.params[0] === 'object') &&
        ...
        !payload.params[0].to, isAspectDeployment = (!!payload.params[0] && typeof payload.params[0] === 'object') && !isContractDeployment
        && payload.params[0].to.toLowerCase() === utils.aspectCoreAddr.toLowerCase()
        && payload.params[0].data
        && payload.params[0].data.substring(0, 10).toLowerCase() === '0x53d4afd5', isAspectCall = (!!payload.params[0] && typeof payload.params[0] === 'object') && !isContractDeployment
        && payload.params[0].to.toLowerCase() === utils.aspectCoreAddr.toLowerCase()
        && payload.params[0].data
        && payload.params[0].data.substring(0, 10).toLowerCase() === '0x995a75e8', hasBytecode = isContractDeployment && payload.params[0].data.length > 2;
            ...
            return (existingReceipt ? promiEvent.resolve(existingReceipt) : _ethereumCall.getTransactionReceipt(result))
                ...
                if (method.call === 'eth_sendRawTransaction') {
                    ...
                    isAspectDeployment = !!parsedTx.to
                        ...
                        && parsedTx.data.substring(0, 10).toLowerCase() === '0x53d4afd5';
                            ...
                            try {
                                if (method.handleRevert &&
                                    ...
                                    if (isAspectCall) {
                                        ...
                                        let aspectOutput = await method.getAspectEntryPointOutput(txReplayOptions, receipt.blockNumber);
                                        defer.eventEmitter.emit('receipt', receipt);
                                        ...
                                        let revertMessage = await method.getRevertReason(txReplayOptions, receipt.blockNumber);
