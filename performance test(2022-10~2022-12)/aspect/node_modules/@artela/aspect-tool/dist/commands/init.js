...
const indextmpl_1 = require("../tmpl/assembly/indextmpl");
const aspect_1 = require("../tmpl/assembly/aspect/aspect");
...
class Init extends core_1.Command {
    ...
    ensureAssemblyDirectory(dir) {
        const projectDir = path_1.default.resolve(dir);
        const assemblyDir = path_1.default.join(projectDir, 'assembly');
    ...
    ensureAspectDirectory(dir) {
        const projectDir = path_1.default.resolve(dir);
        const aspectDir = path_1.default.join(projectDir, 'aspect');
        ...
        const aspectPath = path_1.default.join(aspectDir, 'aspect.ts');
        if (!fs.existsSync(aspectPath)) {
            fs.writeFileSync(aspectPath, aspect_1.AspectTmpl);
        }
    }
