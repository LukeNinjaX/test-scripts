...
evmosd testnet init-files --chain-id evmos_9000-1 --v 5 --output-dir ./testnet --keyring-backend=test --starting-ip-address 172.16.10.2

echo
echo -e "\033[32mconfigure the testnet...\033[0m"
cd $testnet
sed -i "s/172.16.10.3/${inode1}/g" node0/evmosd/config/config.toml
sed -i "s/172.16.10.4/${inode2}/g" node0/evmosd/config/config.toml
sed -i "s/172.16.10.5/${inode3}/g" node0/evmosd/config/config.toml
sed -i "s/172.16.10.6/${inode4}/g" node0/evmosd/config/config.toml

sed -i "s/172.16.10.2/${inode0}/g" node1/evmosd/config/config.toml
sed -i "s/172.16.10.4/${inode2}/g" node1/evmosd/config/config.toml
sed -i "s/172.16.10.5/${inode3}/g" node1/evmosd/config/config.toml
sed -i "s/172.16.10.6/${inode4}/g" node1/evmosd/config/config.toml

sed -i "s/172.16.10.2/${inode0}/g" node2/evmosd/config/config.toml
sed -i "s/172.16.10.3/${inode1}/g" node2/evmosd/config/config.toml
sed -i "s/172.16.10.5/${inode3}/g" node2/evmosd/config/config.toml
sed -i "s/172.16.10.6/${inode4}/g" node2/evmosd/config/config.toml

sed -i "s/172.16.10.2/${inode0}/g" node3/evmosd/config/config.toml
sed -i "s/172.16.10.3/${inode1}/g" node3/evmosd/config/config.toml
sed -i "s/172.16.10.4/${inode3}/g" node3/evmosd/config/config.toml
sed -i "s/172.16.10.6/${inode4}/g" node3/evmosd/config/config.toml

sed -i "s/172.16.10.2/${inode0}/g" node4/evmosd/config/config.toml
sed -i "s/172.16.10.3/${inode1}/g" node4/evmosd/config/config.toml
sed -i "s/172.16.10.4/${inode2}/g" node4/evmosd/config/config.toml
sed -i "s/172.16.10.5/${inode3}/g" node4/evmosd/config/config.toml
...
sed -i 's/"extra_eips": \[\]/"extra_eips": \[3855\]/g' node4/evmosd/config/genesis.json
...
sed -i 's/"amount": "5000000000000000000000"/"amount": "50000000000000000000000000"/g' node4/evmosd/config/genesis.json
...
sed -i 's/allow-unprotected-txs = false/allow-unprotected-txs = true/g' node4/evmosd/config/app.toml
...
sed -i 's/"allow_unprotected_txs": false/"allow_unprotected_txs": true/g' node4/evmosd/config/genesis.json

sed -i 's/timeout_commit = "3s"/timeout_commit = "1s"/g' node0/evmosd/config/config.toml
sed -i 's/timeout_commit = "3s"/timeout_commit = "1s"/g' node1/evmosd/config/config.toml
sed -i 's/timeout_commit = "3s"/timeout_commit = "1s"/g' node2/evmosd/config/config.toml
sed -i 's/timeout_commit = "3s"/timeout_commit = "1s"/g' node3/evmosd/config/config.toml
sed -i 's/timeout_commit = "3s"/timeout_commit = "1s"/g' node4/evmosd/config/config.toml
...
sed -i 's/address = "127.0.0.1:8545"/address = "0.0.0.0:8545"/g' node4/evmosd/config/app.toml
...
scp -r ./node4/evmosd/ root@$node4:/root/.evmosd
